...
//      { test: /src[/\\]assets/, loader: 'arraybuffer-loader'},
      ...
      { test: /\.scss$/, loader: [
        ...
        "css-loader?modules",  // to convert the resulting CSS to Javascript to be bundled (modules:true to rename CSS classes in output to cryptic identifiers, except if wrapped in a :global(...) pseudo class)
